...
$configs = @(
    @{ prefix = "cd3mbpr_pop005_nores_f3e50"; pop = "0.05"; arw = "0.0" },
    @{ prefix = "cd3mbpr_pop010_nores_f3e50"; pop = "0.10"; arw = "0.0" },
    @{ prefix = "cd3mbpr_pop005_res_f3e50";   pop = "0.05"; arw = "1.0" }
)
...
foreach ($c in $configs) {
    ...
    & $python "$root\cold-scence.py" `
        ...
        --matched_bpr --prevalence_bins 10 `
